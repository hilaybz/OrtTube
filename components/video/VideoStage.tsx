...
>(function VideoStage({ videoId, maxSeek, overlay, onProgress }, ref) {
  ...
  return (
    <div className="relative w-full shrink-0 overflow-hidden rounded-[var(--radius)] border border-[var(--glass-border)] bg-black shadow-[0_20px_50px_-24px_rgba(15,23,42,0.55)]">
